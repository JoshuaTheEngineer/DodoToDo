...
public class DodoNotification {

    NotificationManagerCompat notificationManager;
    NotificationCompat.Builder builder;

    // When the user taps the notification, it opens the app's activity
    public DodoNotification(Context context, String customMessage) {
